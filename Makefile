...
include ./$(DEPDIR)/ocat.Po
include ./$(DEPDIR)/ocatlog.Po
include ./$(DEPDIR)/ocatroute.Po
include ./$(DEPDIR)/ocatthread.Po
include ./$(DEPDIR)/ocattun.Po
include ./$(DEPDIR)/ocatv6conv.Po
